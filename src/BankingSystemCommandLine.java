...
public class BankingSystemCommandLine {
	...
	while(exitProgram == false){
		...
		if(userSelection == 2){
			...
			if(controller.checkClient(clientID) == false){
				System.err.println("Error: Client Doesn't Exit");
			}
			else{
	...
	public static void addClient(){
		...
		System.out.println("The client " + firstName + " "+ lastName + " has been added\n");
	}
	...
	public static void removeClient(){
		System.out.println("Enter the Client ID to be removed:");
		int clientID = scanner.nextInt();
