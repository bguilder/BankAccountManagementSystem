...
public class BankingSystemController implements IBankingSystemController {
	...
	//private static IBankingSystemController instance = null;
	...
	/*
	private IBankingSystemController createInstance(ClientIDGenerator clientIDGen, AccountNumberGenerator accountNumGen){
		if (instance == null){
			IBankingSystemController controller = new BankingSystemController(clientIDGen, accountNumGen);
		   return controller;
			//return BankingSystemController.instance;		
		}
		else
			return null;
	}
	
	public IBankingSystemController getInstance(){
		return instance;
	}
	*/
